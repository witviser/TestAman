 ...
 * 
 * ///Date todaysDate = new Date(); timestamp =System.currentTimeMillis();
 * 
 * System.out.println("Timestamp Before: "+ timestamp);
 * 
 * for(int x=0; x < 1000000000; x++) { ctr++; }
 * 
...
int[] arraySize = new int[iterations]
...
System.out.println("Timestamp After: "+timestamp);
